...
const items = [
  {
    id: '1',
    title: 'What makes Pishraft different?',
    content:
      'Pishraft is a fully open-source, developer-first component library built using Next.js and TailwindCSS, designed to help you launch your MVPs in record time. No bloated packages, no unnecessary installs—just clean, copyable code to plug right into your next big thing.',
  },
  {
    id: '2',
    title: 'How can I customize the menus?',
    content:
  ...
  {
    id: '3',
    title: 'Are the team at Pishraft 24-7',
    content:
      "Absolutely! We are available 24-7 for any questions.",
  },
  {
    id: '4',
    title: 'Can I use Pishraft for commercial projects?',
    content:
      'Yes, Pishraft is free to use for both personal and commercial projects. No attribution required—just build and launch your MVP faster than ever before.',
  },
  {
    id: '5',
    title: 'How do I get started with Pishraft?',
    content:
      "Simply browse our starts guide, find the guide you need, and get started. It's that easy! Our documentation provides clear instructions for more info.",
  },
];
    ...
    <section className="py-12 md:py-16">
      <div className="container mx-auto max-w-6xl px-4 md:px-6">
        <div className="mb-10 text-center">
          ...
          >
            Frequently Asked{' '}
            <span className="from-primary bg-gradient-to-r to-neutral-400 bg-clip-text text-transparent">
              Questions
            </span>
          </motion.h2>
          <motion.p
